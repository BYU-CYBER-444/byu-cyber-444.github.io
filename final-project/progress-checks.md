...
**Due:** Thursday, Nov 12 &nbsp;·&nbsp; **Weight:** 2.5% of course grade (100 pts)
{: .fs-5 }
...
Your playbook or configuration must be fully idempotent — running it a second time must produce 0 changed. Use handlers correctly (for example, restarting `auditd` when audit rules change). Tasks must be clearly named and logically grouped.
...
**Due:** Thursday, Dec 3 &nbsp;·&nbsp; **Weight:** 2.5% of course grade (100 pts)
{: .fs-5 }
