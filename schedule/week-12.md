...
- Hypervisor security (Type 1 vs. Type 2 hardening, VM isolation)
- CIS VMware/Hyper-V benchmarks
- Docker security model (namespaces, cgroups, capabilities)
...
[LAB 12 - Docker Security Hardening]({% link labs/lab-12.md %})

---

## Quiz / Assessment

Quiz 10: Docker/container security concepts (10 Qs)
